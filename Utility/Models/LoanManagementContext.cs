...
namespace Utility.Models
{
    public partial class LoanManagementContext : DbContext
    {
        ...
        public virtual DbSet<AgentBalanceMst> AgentBalanceMst { get; set; }
        public virtual DbSet<AgentFund> AgentFund { get; set; }
        public virtual DbSet<AgentReturnedFund> AgentReturnedFund { get; set; }
        ...
        public virtual DbSet<Vbtrans> Vbtrans { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        {
            modelBuilder.Entity<AgentBalanceMst>(entity =>
            {
                ...
                entity.HasOne(d => d.Agent)
                    .WithMany(p => p.AgentBalanceMst)
                    .HasForeignKey(d => d.AgentId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_AgentBalanceMst_LoginCredentials");
            });

            modelBuilder.Entity<AgentFund>(entity =>
            {
                entity.Property(e => e.AgentFundId).HasColumnName("AgentFundID");
                ...
                entity.Property(e => e.IsReceive).HasDefaultValueSql("((0))");
                ...
                entity.HasOne(d => d.Agent)
                    .WithMany(p => p.AgentFundAgent)
                    .HasForeignKey(d => d.AgentId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_AgentLoan_LoginCredentials");

                entity.HasOne(d => d.CreatedByNavigation)
                    .WithMany(p => p.AgentFundCreatedByNavigation)
                    .HasForeignKey(d => d.CreatedBy)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_AgentFund_LoginCredentials");
            });

            modelBuilder.Entity<AgentReturnedFund>(entity =>
            {
            ...
            modelBuilder.Entity<CustomerLoan>(entity =>
            {
                ...
                entity.Property(e => e.InterestPayAt)
                    .HasMaxLength(20)
                    .IsUnicode(false);
                ...
                entity.HasOne(d => d.Agent)
                    .WithMany(p => p.CustomerLoanAgent)
                    .HasForeignKey(d => d.AgentId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_CustomerLoan_AgentLoginCredentials");

                entity.HasOne(d => d.CreatedByNavigation)
                    .WithMany(p => p.CustomerLoanCreatedByNavigation)
                    .HasForeignKey(d => d.CreatedBy)
                    .HasConstraintName("FK_CustomerLoan_LoginCredentials1");

                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.CustomerLoanCustomer)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_CustomerLoan_LoginCredentials");
            ...
            modelBuilder.Entity<Vbtrans>(entity =>
            {
                entity.ToTable("VBTrans");

                entity.Property(e => e.VbtransId).HasColumnName("VBTransId");
                ...
                entity.HasOne(d => d.Agent)
                    .WithMany(p => p.Vbtrans)
                    .HasForeignKey(d => d.AgentId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_VBTrans_LoginCredentials");
            });
